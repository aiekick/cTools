...
int Test_cTools_Vec2_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec2.[]") != std::string::npos) {
        if (is_equal(v[0], (T)5.0) && is_equal(v[1], (T)2.0))
            return 0;
    } else if (vTestCode.find(".Vec2.Offset") != std::string::npos) {
        v = v.Offset((T)1.0, (T)2.0);
        if (is_equal(v.x, (T)6.0) && is_equal(v.y, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec2.Set") != std::string::npos) {
        v.Set((T)1.0, (T)2.0);
        if (is_equal(v.x, (T)1.0) && is_equal(v.y, (T)2.0))
            return 0;
    } else if (vTestCode.find(".Vec2.-") != std::string::npos) {
        v = -v;
        if (is_equal(v.x, (T)-5.0) && is_equal(v.y, (T)-2.0))
            return 0;
    } else if (vTestCode.find(".Vec2.post++") != std::string::npos) {
        const auto& vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec2.post--") != std::string::npos) {
        const auto& vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0))
            return 0;
    } else if (vTestCode.find(".Vec2.pre++") != std::string::npos) {
        const auto& vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec2.pre--") != std::string::npos) {
        const auto& vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0))
            return 0;
    } else if (vTestCode.find(".Vec2.+=a") != std::string::npos) {
        v += (T)2.5f;
        if (is_equal(v.x, (T)7.5) && is_equal(v.y, (T)4.5))
            return 0;
    } else if (vTestCode.find(".Vec2.+=Vec2") != std::string::npos) {
        v += ct::vec2<T>((T)2.0, (T)4.0);
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)6.0))
            return 0;
    } else if (vTestCode.find(".Vec2.-=a") != std::string::npos) {
        v -= (T)2.5;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)-0.5))
            return 0;
    } else if (vTestCode.find(".Vec2.-=Vec2") != std::string::npos) {
        v -= ct::vec2<T>((T)2.0, (T)4.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0))
            return 0;
    } else if (vTestCode.find(".Vec2.==a") != std::string::npos) {
        v = (T)2.5;
        bool vb = (v == (T)2.5);
        ...
        bool vb = (v != ct::vec2<T>((T)6.0, (T)2.0)) && (v != ct::vec2<T>((T)5.0, (T)3.0)) && (v != ct::vec2<T>((T)6.0, (T)3.0));
        if (vb)
            return 0;
    } else if (vTestCode.find(".Vec2.*=a") != std::string::npos) {
        v *= (T)2.0;
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec2.*=Vec2") != std::string::npos) {
        v *= ct::vec2<T>((T)2.0, (T)4.0);
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)8.0))
            return 0;
    } else if (vTestCode.find(".Vec2./=a") != std::string::npos) {
        v /= (T)2.0;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)1.0))
            return 0;
    } else if (vTestCode.find(".Vec2./=Vec2") != std::string::npos) {
        v /= ct::vec2<T>((T)2.0, (T)4.0);
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)0.5))
        ...
        v.normalize();
        T post_len = v.length();
        if ((!is_equal(pre_len, (T)1.0)) && is_equal(post_len, (T)1.0))
            return 0;
...
int Test_cTools_Vec2_run_test<bool>(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec2.[]") != std::string::npos) {
        ...
        if ((v != ct::bvec2(false, true)) && (v != ct::bvec2(true, true)) && (v != ct::bvec2(false, false)))
            return 0;
    } else if (vTestCode.find(".Vec2.emptyAND") != std::string::npos) {
        bool vb = v.emptyAND();
        if (!vb)
...
int Test_cTools_signed_integer_Vec2_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec2.[]") != std::string::npos) {
        ...
        v -= (T)1.0;
        if (is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0))
            return 0;
    } else if (vTestCode.find(".Vec2.-=Vec2") != std::string::npos) {
        v -= ct::vec2<T>((T)2.0, (T)4.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0))
...
int Test_cTools_unsigned_integer_Vec2_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec2.[]") != std::string::npos) {
        ...
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)1.0))
            return 0;
    } else if (vTestCode.find(".Vec2.==a") != std::string::npos) {
        v = (T)2.5;
        bool vb = (v == (T)2.5);
...
int Test_cTools_Vec3_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec3.[]") != std::string::npos) {
        if (is_equal(v[0], (T)5.0) && is_equal(v[1], (T)2.0) && is_equal(v[2], (T)6.5))
            return 0;
    } else if (vTestCode.find(".Vec3.Offset") != std::string::npos) {
        v = v.Offset((T)1.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)6.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)9.5))
            return 0;
    } else if (vTestCode.find(".Vec3.Set") != std::string::npos) {
        v.Set((T)1.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)1.0) && is_equal(v.y, (T)2.0) && is_equal(v.z, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec3.-") != std::string::npos) {
        v = -v;
        if (is_equal(v.x, (T)-5.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)-6.5))
            return 0;
    } else if (vTestCode.find(".Vec3.xy") != std::string::npos) {
        const auto& v2 = v.xy();
        if (is_equal(v2.x, (T)5.0) && is_equal(v2.y, (T)2.0))
            return 0;
    } else if (vTestCode.find(".Vec3.xz") != std::string::npos) {
        const auto& v2 = v.xz();
        if (is_equal(v2.x, (T)5.0) && is_equal(v2.y, (T)6.5))
            return 0;
    } else if (vTestCode.find(".Vec3.yz") != std::string::npos) {
        const auto& v2 = v.yz();
        if (is_equal(v2.x, (T)2.0) && is_equal(v2.y, (T)6.5))
            return 0;
    } else if (vTestCode.find(".Vec3.yzx") != std::string::npos) {
        const auto& v3 = v.yzx();
        if (is_equal(v3.x, (T)2.0) && is_equal(v3.y, (T)6.5) && is_equal(v3.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.post++") != std::string::npos) {
        const auto& vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.5) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.5))
            return 0;
    } else if (vTestCode.find(".Vec3.post--") != std::string::npos) {
        const auto& vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.5) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec3.pre++") != std::string::npos) {
        const auto& vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)7.5) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.5))
            return 0;
    } else if (vTestCode.find(".Vec3.pre--") != std::string::npos) {
        const auto& vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)5.5) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec3.+=a") != std::string::npos) {
        v += (T)2.5f;
        if (is_equal(v.x, (T)7.5) && is_equal(v.y, (T)4.5) && is_equal(v.z, (T)9.0))
            return 0;
    } else if (vTestCode.find(".Vec3.+=Vec3") != std::string::npos) {
        v += ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)6.0) && is_equal(v.z, (T)8.5))
            return 0;
    } else if (vTestCode.find(".Vec3.-=a") != std::string::npos) {
        v -= (T)2.5;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)-0.5) && is_equal(v.z, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec3.-=Vec3") != std::string::npos) {
        v -= ct::vec3<T>((T)2.0, (T)4.0, (T)1.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec3.==a") != std::string::npos) {
        v = (T)2.5;
        bool vb = (v == (T)2.5);
        ...
        bool vb = (v != ct::vec3<T>((T)6.0, (T)2.0, (T)6.5)) && (v != ct::vec3<T>((T)5.0, (T)3.0, (T)6.5)) && (v != ct::vec3<T>((T)6.0, (T)3.0, (T)6.5)) &&
            (v != ct::vec3<T>((T)2.0, (T)1.0, (T)6.5));
        if (vb)
            return 0;
    } else if (vTestCode.find(".Vec3.*=a") != std::string::npos) {
        v *= (T)2.0;
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)13.0))
            return 0;
    } else if (vTestCode.find(".Vec3.*=Vec3") != std::string::npos) {
        v *= ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)8.0) && is_equal(v.z, (T)13.0))
            return 0;
    } else if (vTestCode.find(".Vec3./=a") != std::string::npos) {
        v /= (T)2.0;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.25))
            return 0;
    } else if (vTestCode.find(".Vec3./=Vec3") != std::string::npos) {
        v /= ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)0.5) && is_equal(v.z, (T)3.25))
            return 0;
        ...
        const auto& str = v.string();
        const auto& str_coma = v.string(',');
        if (str == "5.35;-2.8;3.8" && str_coma == "5.35,-2.8,3.8")
            return 0;
...
int Test_cTools_Vec3_run_test<bool>(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec3.[]") != std::string::npos) {
        ...
        if ((v != ct::bvec3(false, true, true)) && (v != ct::bvec3(true, true, true)) && (v != ct::bvec3(false, false, true)))
            return 0;
    } else if (vTestCode.find(".Vec3.emptyAND") != std::string::npos) {
        bool vb = v.emptyAND();
        if (!vb)
...
int Test_cTools_signed_integer_Vec3_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec3.[]") != std::string::npos) {
        if (is_equal(v[0], (T)5.0) && is_equal(v[1], (T)2.0) && is_equal(v[2], (T)6.0))
            return 0;
    } else if (vTestCode.find(".Vec3.Offset") != std::string::npos) {
        v = v.Offset((T)1.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)6.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)9.0))
            return 0;
    } else if (vTestCode.find(".Vec3.Set") != std::string::npos) {
        v.Set((T)1.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)1.0) && is_equal(v.y, (T)2.0) && is_equal(v.z, (T)3.0))
        ...
        v = -v;
        if (is_equal(v.x, (T)-5.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)-6.0))
            return 0;
    } else if (vTestCode.find(".Vec3.xy") != std::string::npos) {
        const auto& v2 = v.xy();
        if (is_equal(v2.x, (T)5.0) && is_equal(v2.y, (T)2.0))
        ...
        const auto& v2 = v.yz();
        if (is_equal(v2.x, (T)2.0) && is_equal(v2.y, (T)6.0))
            return 0;
    } else if (vTestCode.find(".Vec3.yzx") != std::string::npos) {
        const auto& v3 = v.yzx();
        if (is_equal(v3.x, (T)2.0) && is_equal(v3.y, (T)6.0) && is_equal(v3.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.post++") != std::string::npos) {
        const auto& vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.0))
            return 0;
    } else if (vTestCode.find(".Vec3.post--") != std::string::npos) {
        const auto& vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.pre++") != std::string::npos) {
        const auto& vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)7.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.0))
            return 0;
    } else if (vTestCode.find(".Vec3.pre--") != std::string::npos) {
        const auto& vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)5.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.+=a") != std::string::npos) {
        v += (T)2.0f;
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)8.0))
            return 0;
    } else if (vTestCode.find(".Vec3.+=Vec3") != std::string::npos) {
        v += ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)6.0) && is_equal(v.z, (T)8.0))
            return 0;
    } else if (vTestCode.find(".Vec3.-=a") != std::string::npos) {
        v -= (T)2.0;
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec3.-=Vec3") != std::string::npos) {
        v -= ct::vec3<T>((T)2.0, (T)4.0, (T)1.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.==a") != std::string::npos) {
        v = (T)2.0;
        bool vb = (v == (T)2.0);
        ...
        bool vb = (v != ct::vec3<T>((T)6.0, (T)2.0, (T)6.0)) && (v != ct::vec3<T>((T)5.0, (T)3.0, (T)6.0)) && (v != ct::vec3<T>((T)6.0, (T)3.0, (T)6.0)) &&
            (v != ct::vec3<T>((T)2.0, (T)1.0, (T)6.0));
        if (vb)
            return 0;
    } else if (vTestCode.find(".Vec3.*=a") != std::string::npos) {
        v *= (T)2.0;
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)12.0))
            return 0;
    } else if (vTestCode.find(".Vec3.*=Vec3") != std::string::npos) {
        v *= ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)8.0) && is_equal(v.z, (T)12.0))
            return 0;
    } else if (vTestCode.find(".Vec3./=a") != std::string::npos) {
        v /= (T)2.0;
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec3./=Vec3") != std::string::npos) {
        v /= ct::vec3<T>((T)2.0, (T)4.0, (T)2.0);
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)3.0))
            return 0;
    }
    /*
    else if (vTestCode.find(".Vec3.lengthSquared") != std::string::npos)
...
int Test_cTools_unsigned_integer_Vec3_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec3.[]") != std::string::npos) {
        ...
        v -= (T)2.0;
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec3.-=Vec3") != std::string::npos) {
        v -= ct::vec3<T>((T)2.0, (T)2.0, (T)1.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec3.==a") != std::string::npos) {
        v = (T)2.0;
        bool vb = (v == (T)2.0);
...
int Test_cTools_Vec4_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec4.[]") != std::string::npos) {
        if (is_equal(v[0], (T)5.0) && is_equal(v[1], (T)2.0) && is_equal(v[2], (T)4.5) && is_equal(v[3], (T)6.5))
            return 0;
    } else if (vTestCode.find(".Vec4.Offset") != std::string::npos) {
        v = v.Offset((T)1.0, (T)2.0, (T)3.0, (T)2.0);
        if (is_equal(v.x, (T)6.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)7.5) && is_equal(v.w, (T)8.5))
            return 0;
    } else if (vTestCode.find(".Vec4.Set") != std::string::npos) {
        v.Set((T)1.0, (T)2.0, (T)3.0, (T)2.0);
        if (is_equal(v.x, (T)1.0) && is_equal(v.y, (T)2.0) && is_equal(v.z, (T)3.0) && is_equal(v.w, (T)2.0))
            return 0;
    } else if (vTestCode.find(".Vec4.-") != std::string::npos) {
        v = -v;
        if (is_equal(v.x, (T)-5.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)-4.5) && is_equal(v.w, (T)-6.5))
            return 0;
        ...
        const auto& v3 = v.xyz();
        if (is_equal(v3.x, (T)5.0) && is_equal(v3.y, (T)2.0) && is_equal(v3.z, (T)4.5))
            return 0;
    } else if (vTestCode.find(".Vec4.zw") != std::string::npos) {
        const auto& v2 = v.zw();
        if (is_equal(v2.x, (T)4.5) && is_equal(v2.y, (T)6.5))
            return 0;
    } else if (vTestCode.find(".Vec4.SizeLBRT") != std::string::npos) {
        const auto& v2 = v.SizeLBRT();
        if (is_equal(v2.x, (T)-0.5) && is_equal(v2.y, (T)4.5))
            return 0;
        ...
        const auto& vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.5) && is_equal(vc.w, (T)6.5) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) &&
            is_equal(v.z, (T)5.5) && is_equal(v.w, (T)7.5))
            return 0;
    } else if (vTestCode.find(".Vec4.post--") != std::string::npos) {
        const auto& vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.5) && is_equal(vc.w, (T)6.5) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) &&
            is_equal(v.z, (T)3.5) && is_equal(v.w, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec4.pre++") != std::string::npos) {
        const auto& vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)5.5) && is_equal(vc.w, (T)7.5) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) &&
            is_equal(v.z, (T)5.5) && is_equal(v.w, (T)7.5))
            return 0;
    } else if (vTestCode.find(".Vec4.pre--") != std::string::npos) {
        const auto& vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)3.5) && is_equal(vc.w, (T)5.5) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) &&
            is_equal(v.z, (T)3.5) && is_equal(v.w, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec4.+=a") != std::string::npos) {
        v += (T)2.5f;
        if (is_equal(v.x, (T)7.5) && is_equal(v.y, (T)4.5) && is_equal(v.z, (T)7.0) && is_equal(v.w, (T)9.0))
            return 0;
    } else if (vTestCode.find(".Vec4.+=Vec4") != std::string::npos) {
        v += ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)4.0);
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)6.0) && is_equal(v.z, (T)6.5) && is_equal(v.w, (T)10.5))
            return 0;
    } else if (vTestCode.find(".Vec4.-=a") != std::string::npos) {
        v -= (T)2.5;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)-0.5) && is_equal(v.z, (T)4.0) && is_equal(v.w, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec4.-=Vec4") != std::string::npos) {
        v -= ct::vec4<T>((T)2.0, (T)4.0, (T)1.0, (T)2.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)5.5) && is_equal(v.w, (T)5.5))
            return 0;
    } else if (vTestCode.find(".Vec4.==a") != std::string::npos) {
        v = (T)2.5;
        bool vb = (v == (T)2.5);
        ...
        bool vb = (v != ct::vec4<T>((T)6.0, (T)2.0, (T)6.5, (T)2.5)) && (v != ct::vec4<T>((T)5.0, (T)3.0, (T)6.5, (T)2.5)) &&
            (v != ct::vec4<T>((T)6.0, (T)3.0, (T)6.5, (T)2.5)) && (v != ct::vec4<T>((T)2.0, (T)1.0, (T)6.5, (T)2.5));
        if (vb)
            return 0;
    } else if (vTestCode.find(".Vec4.*=a") != std::string::npos) {
        v *= (T)2.0;
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)9.0) && is_equal(v.w, (T)13.0))
            return 0;
    } else if (vTestCode.find(".Vec4.*=Vec4") != std::string::npos) {
        v *= ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)8.0) && is_equal(v.z, (T)9.0) && is_equal(v.w, (T)19.5))
            return 0;
    } else if (vTestCode.find(".Vec4./=a") != std::string::npos) {
        v /= (T)2.0;
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)2.25) && is_equal(v.w, (T)3.25))
            return 0;
    } else if (vTestCode.find(".Vec4./=Vec4") != std::string::npos) {
        v /= ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)2.0);
        if (is_equal(v.x, (T)2.5) && is_equal(v.y, (T)0.5) && is_equal(v.z, (T)2.25) && is_equal(v.w, (T)3.25))
            return 0;
        ...
        const auto& str = v.string();
        const auto& str_coma = v.string(',');
        if (str == "5.35;-2.8;3.8;2.9" && str_coma == "5.35,-2.8,3.8,2.9")
            return 0;
...
int Test_cTools_Vec4_run_test<bool>(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec4.[]") != std::string::npos) {
        ...
        if ((v != ct::bvec4(false, true, true, false)) && (v != ct::bvec4(true, true, true, false)) && (v != ct::bvec4(false, false, true, false)))
            return 0;
    } else if (vTestCode.find(".Vec4.emptyAND") != std::string::npos) {
        bool vb = v.emptyAND();
        if (!vb)
        ...
        const auto& str = v.string();
        const auto& str_coma = v.string(',');
        if (str == "1;0;1;0" && str_coma == "1,0,1,0")
            return 0;
    } else if (vTestCode.find(".Vec4.mini") != std::string::npos) {
        bool mini = v.mini();
        if (!mini)
...
int Test_cTools_signed_integer_Vec4_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec4.[]") != std::string::npos) {
        if (is_equal(v[0], (T)5.0) && is_equal(v[1], (T)2.0) && is_equal(v[2], (T)4.0) && is_equal(v[3], (T)6.0))
            return 0;
    } else if (vTestCode.find(".Vec4.Offset") != std::string::npos) {
        v = v.Offset((T)1.0, (T)2.0, (T)3.0, (T)2.0);
        if (is_equal(v.x, (T)6.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)7.0) && is_equal(v.w, (T)8.0))
            return 0;
    } else if (vTestCode.find(".Vec4.Set") != std::string::npos) {
        v.Set((T)1.0, (T)2.0, (T)3.0, (T)2.0);
        if (is_equal(v.x, (T)1.0) && is_equal(v.y, (T)2.0) && is_equal(v.z, (T)3.0) && is_equal(v.w, (T)2.0))
        ...
        v = -v;
        if (is_equal(v.x, (T)-5.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)-4.0) && is_equal(v.w, (T)-6.0))
            return 0;
    } else if (vTestCode.find(".Vec4.xy") != std::string::npos) {
        const auto& v2 = v.xy();
        if (is_equal(v2.x, (T)5.0) && is_equal(v2.y, (T)2.0))
        ...
        const auto& v2 = v.SizeLBRT();
        if (is_equal(v2.x, (T)-1.0) && is_equal(v2.y, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec4.pos") != std::string::npos) {
        const auto& v2 = v.pos();
        if (is_equal(v2.x, (T)5.0) && is_equal(v2.y, (T)2.0))
        ...
        const auto& v2 = v.size();
        if (is_equal(v2.x, (T)4.0) && is_equal(v2.y, (T)6.0))
            return 0;
    } else if (vTestCode.find(".Vec4.post++") != std::string::npos) {
        const auto& vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.0) && is_equal(vc.w, (T)6.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) &&
            is_equal(v.z, (T)5.0) && is_equal(v.w, (T)7.0))
            return 0;
    } else if (vTestCode.find(".Vec4.post--") != std::string::npos) {
        const auto& vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.0) && is_equal(vc.w, (T)6.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) &&
            is_equal(v.z, (T)3.0) && is_equal(v.w, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec4.pre++") != std::string::npos) {
        const auto& vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)5.0) && is_equal(vc.w, (T)7.0) && is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) &&
            is_equal(v.z, (T)5.0) && is_equal(v.w, (T)7.0))
            return 0;
    } else if (vTestCode.find(".Vec4.pre--") != std::string::npos) {
        const auto& vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)3.0) && is_equal(vc.w, (T)5.0) && is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) &&
            is_equal(v.z, (T)3.0) && is_equal(v.w, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec4.+=a") != std::string::npos) {
        v += (T)2.0;
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)6.0) && is_equal(v.w, (T)8.0))
            return 0;
    } else if (vTestCode.find(".Vec4.+=Vec4") != std::string::npos) {
        v += ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)4.0);
        if (is_equal(v.x, (T)7.0) && is_equal(v.y, (T)6.0) && is_equal(v.z, (T)6.0) && is_equal(v.w, (T)10.0))
            return 0;
    } else if (vTestCode.find(".Vec4.-=a") != std::string::npos) {
        v -= (T)2.0;
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)-0.0) && is_equal(v.z, (T)4.0) && is_equal(v.w, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec4.-=Vec4") != std::string::npos) {
        v -= ct::vec4<T>((T)2.0, (T)4.0, (T)1.0, (T)2.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)-2.0) && is_equal(v.z, (T)5.0) && is_equal(v.w, (T)5.0))
            return 0;
    } else if (vTestCode.find(".Vec4.==a") != std::string::npos) {
        v = (T)2.0;
        bool vb = (v == (T)2.0);
        ...
        bool vb = (v != ct::vec4<T>((T)6.0, (T)2.0, (T)6.0, (T)2.0)) && (v != ct::vec4<T>((T)5.0, (T)3.0, (T)6.0, (T)2.0)) &&
            (v != ct::vec4<T>((T)6.0, (T)3.0, (T)6.0, (T)2.0)) && (v != ct::vec4<T>((T)2.0, (T)1.0, (T)6.0, (T)2.0));
        if (vb)
            return 0;
    } else if (vTestCode.find(".Vec4.*=a") != std::string::npos) {
        v *= (T)2.0;
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)4.0) && is_equal(v.z, (T)8.0) && is_equal(v.w, (T)12.0))
            return 0;
    } else if (vTestCode.find(".Vec4.*=Vec4") != std::string::npos) {
        v *= ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)3.0);
        if (is_equal(v.x, (T)10.0) && is_equal(v.y, (T)8.0) && is_equal(v.z, (T)8.0) && is_equal(v.w, (T)18.0))
            return 0;
    } else if (vTestCode.find(".Vec4./=a") != std::string::npos) {
        v /= (T)2.0;
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)2.0) && is_equal(v.w, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec4./=Vec4") != std::string::npos) {
        v /= ct::vec4<T>((T)2.0, (T)4.0, (T)2.0, (T)2.0);
        if (is_equal(v.x, (T)2.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)2.0) && is_equal(v.w, (T)3.0))
            return 0;
    } else if (vTestCode.find(".Vec4.sum") != std::string::npos) {
        v = ct::vec4<T>((T)5.0, (T)-2.0, (T)3.0, (T)5.0);
        T len = v.sum();
        ...
        const auto& str = v.string();
        const auto& str_coma = v.string(',');
        if (str == "5;-2;3;2" && str_coma == "5,-2,3,2")
            return 0;
    } else if (vTestCode.find(".Vec4.mini") != std::string::npos) {
        T mini = v.mini();
        if (is_equal(mini, (T)2.0))
...
int Test_cTools_unsigned_integer_Vec4_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Vec4.[]") != std::string::npos) {
        ...
        v -= (T)2.0;
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)2.0) && is_equal(v.w, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec4.-=Vec4") != std::string::npos) {
        v -= ct::vec4<T>((T)2.0, (T)2.0, (T)1.0, (T)2.0);
        if (is_equal(v.x, (T)3.0) && is_equal(v.y, (T)0.0) && is_equal(v.z, (T)3.0) && is_equal(v.w, (T)4.0))
            return 0;
    } else if (vTestCode.find(".Vec4.==a") != std::string::npos) {
        v = (T)2.0;
        bool vb = (v == (T)2.0);
...
int Test_cTools_float_double_Plane_run_test(const std::string& vTestCode) {
    ...
    if (vTestCode.find(".Plane.get_plane_intersection") != std::string::npos) {
        ...
        return !ct::is_on_plane(a, good_result) && !ct::is_on_plane(b, good_result) && !ct::is_on_plane(c, good_result);
